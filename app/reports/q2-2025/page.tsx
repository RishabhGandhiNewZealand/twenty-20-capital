            ...
            <CardContent>
              <div className="space-y-6">
                ...
                <div className="border-l-4 border-blue-200 pl-4">
                  ...
                  <p className="text-gray-700 mb-2">
                    Mainfreight reported their annual results this quarter, their revenue is up 11% while profit is down 3% before tax. Considering the macro environment, Mainfreight is executing well in all its regions except the USA. This region is struggling to get going at the same speed as others; however, I have faith that over the next 5 years, it will become a profit center. we think they can grow revenue by 8-10% comfortably and they have demonstrated that. Their profitability will improve as they continue to win market share and the macro environment improves, and if it doesn't the company will still do well as I have faith in the management execution ability. Every year they win market share with better service and build better infrastructure to give betters service the moat continues to improve. The company is still lagging the rest of our portfolio, there we think two reasons for this, NZ is not great now as a country, thus capital is slow to go into companies, and since MFT is only listed on the NZX, this further adds to this issue. However, over the long term the value of the company follows its fundamentals. During a pre-earnings dip, I added another $1000 dollars to the company reducing my cost basis. And we will add more if the prices stay below 60$ a share.
                  </p>
                  <div className="mt-3 p-3 bg-gray-50 rounded">
            ...
            <CardContent>
              <div className="space-y-6">
                ...
                <div className="border-l-4 border-yellow-200 pl-4">
                  ...
                  <p className="text-gray-700 mb-2">
                    Meta continues to deliver above expectations and people are finally starting to realize the potential that this company has, especially in the age of AI. we think this business is one of the best in the world with a very high barrier to entry. we think that 20%+ EPS growth can continue despite the heavy investments in AI. The company has yet to monetize WhatsApp and threads, which have 1B+ daily active users. Their operating costs are starting to flatline. They now need to prepare their business for AI, which they are doing well, They are pouring massive amount of money into AI, on top of their Infra Capex investments, they bought a share of Scale AI to hire its founder and have poached huge talents from Other key AI players for massive compensation packages at 100M+. I would like to add to this company, but the market is slowly realizing this and is valuing it appropriately.
                  </p>
                  <div className="mt-3 p-3 bg-gray-50 rounded">
                ...
                <div className="border-l-4 border-yellow-200 pl-4">
                  ...
                  <p className="text-gray-700 mb-2">
                    The story for Netflix remains unchanged. They grew revenue at 14% and profit at 46%. Their operating leverage is now showing. There was an internal Memo leak, where the management is expecting to hit a 1T market cap in the next 5 years. This was in line with my expectations of 500 million subscribers. The market has swiftly priced the company up to 500 million in market cap at a price of $1300 a share. That still gives a 15% return if management meet their targets, but we think Netflix is overvalued now and has valuation risk associated with it now. However, the company is just too good to sell at this stage. It still has years of revenue growth ahead and we think the company will still be around in 10 years. Often the market underestimates margin expansion so selling now would still be a mistake. Even at $1300, we think NFLX will still beat the market in 5 years' time. Letting the winners run.
                  </p>
                  <div className="mt-3 p-3 bg-gray-50 rounded">
                ...
                <div className="border-l-4 border-yellow-200 pl-4">
                  ...
                  <p className="text-gray-700 mb-2">
                    Like last quarter S and P Global continued along its way this quarter, with business as usual. The story remained as it is and the company's performance was within expectations. The biggest news for S&P global this quarter is that they plan to spin out their automotive mobility segment into its individual company. This is interesting news, we think long term this is a great benefit for SPGI. Most likely, when this happens, we will sell any shares in the mobility division to buy more SPGI as we think SPGI will be a higher quality higher margin business afterwards. SPGI lags the market this year in price, but strong fundamentals means no cause for concern.
                  </p>
                  <div className="mt-3 p-3 bg-gray-50 rounded">
            ...
            <CardContent>
              <div className="text-gray-700 space-y-4">
                <div className="mt-6">
                  ...
                  <p>
                    Lets talk more tariffs, after the initial announcements and further reciprocal tariffs. Things have mostly calmed down, and tariffs have been walked back. And the market has recovered, although the dollar remains slightly weaker. we think the dollar will continue to get weaker through the rest of the year. But that is just a hunch. Moreover, at the start of July, the initial 90 day pauses have worn off and will likely kick back into effect. At this stage the market is unsure of how to deal with this. But we think the general gist of it remains the same as last quarter. The market is fundamentally strong just with macro and geo-political uncertainty. Will continue to buy companies and in the US. Unless there is good opportunity in other markets. Ideally, I would like to add one more global holding to our portfolio, but most of my companies have a large portion of their revenues outside of the US so maybe it is not necessary.
                  </p>
                </div>
              </div>
            </CardContent>
