        ...
        <div className="space-y-8">
          ...
          <Card className="border-blue-100">
            ...
            <CardContent>
              <div className="text-gray-700 space-y-4">
                <p>
                  <strong>Goal:</strong> Avoid permanent capital loss and achieve a +5% return on the index for the next 40+ years. The primary comparison point will be the S&P 500 on an unhedged basis. we will be comparing them on a money-weighted return basis, this will account for inflows of capital into the portfolio. I added roughly {formatCurrency(5000)} this quarter into the portfolio and plan to maintain or exceed this level of contribution next quarter.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-blue-100">
            ...
            <CardContent>
              <div className="text-gray-700 space-y-4">
                <p>
                  This quarter, the portfolio delivered solid results, posting a return of approximately 10%—closely tracking the performance of the index. The market demonstrated resilience, staging a strong rebound in the aftermath of tariff concerns. Despite persistent and escalating geopolitical uncertainty, investor sentiment remained largely undisturbed, contributing to rising valuations and profitability. Reflecting these conditions, I maintained an active approach: we increased my allocation to two existing positions, initiated three new ones, and fully exited another. Notably, several of these acquisitions were strategic moves to diversify beyond US tech and boost my exposure to international markets.
                </p>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent>
              <div className="space-y-6">
                ...
                <div className="border-l-4 border-blue-200 pl-4">
                  ...
                  <p className="text-gray-700 mb-2">
                    Currently, Zeta trades at approximately 4x price-to-sales, growing at 30%+ annually, and has the potential to achieve 30%+ operating margins within the next five to ten years. If the company sustains its current growth rate over the next five years, we believe there is a realistic path for the stock to increase tenfold from current levels. Artificial intelligence is a significant tailwind, simplifying customer onboarding and enabling even more effective, customised marketing solutions. The market appears to underestimate both the strength and stickiness of Zeta’s business model. Provided management’s claims about customer ROI hold true, the company’s future looks promising—despite the recent erosion of market confidence due to the short report and lawsuit.
                  </p>
                  <div className="mt-3 p-3 bg-gray-50 rounded">
            ...
            <CardContent>
              <div className="space-y-6">
                <div className="border-l-4 border-yellow-200 pl-4">
                  ...
                  <p className="text-gray-700 mb-2">
                    Importantly, Google recently announced a major quantum computing breakthrough. While the market has largely ignored this development, we believe Google’s leadership in quantum computing will become transformative over the next decade, adding yet another layer to its long-term growth story.
                  </p>
                  <p className="text-gray-700 mb-2">
