    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">A comprehensive look at our investment performance in 2024</p>
        </div>
        ...
        <div className="space-y-8">
          ...
          <Card className="border-blue-100">
            ...
            <CardContent>
              <div className="prose text-gray-700">
                <p>2024 was the first complete calendar year for our portfolio. This is a summary of the performance and activities of our portfolio. I also review some of the rationale behind my investments for maximum transparency.</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-blue-100">
            ...
            <CardContent>
              <div className="prose text-gray-700">
                <p>At the start of this year, I owned two companies in our portfolio, Canadian Pacific Kansas City Railway (CP: NYSE) and Mainfreight (MFT: NZE). I finished the year with a total of 11 holdings.</p>
                ...
                <p>The S&P 500 returned 20.8% on a money-weighted basis this year, while our portfolio returned 16.6%.</p>

                <p>A few general thoughts on why we think the portfolio was fairly in line with the index. we did have some underperformance and that was largely contributed by holding Mainfreight as the largest holding in our portfolio for the majority of the year. This meant the performanace was largely tied to the performance of Mainfreight which had mediocore stock performance. Albeit the company did well fundamentally. The underperfomance was counteracted slightly by the NZ dollar getting significantly weaker against the US dollar. Falling from 0.63 to 0.56 through the year. Excluding Mainfreight and FX effects the perfomance of the portfolio was likely in the range of ~30%. </p>
          ...
          <Card className="border-blue-100">
                ...
                <div className="bg-blue-50 rounded-lg p-4 min-w-fit">
                  <div className="grid grid-cols-4 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <div className="font-semibold">{formatNumber(50, 0)} shares</div>
                    </div>
                    <div>
            ...
            <CardContent>
              <div className="prose text-gray-700">
                ...
                <p>We started the year with a substantial position in Mainfreight on the NZX, initially valued at approximately 5600 NZD. This company has yielded a 9.27% return, including dividends, over the past year, while the NZX50 index increased by 11.03%. we still firmly believe that Mainfreight is the best public company in New Zealand, which is why it remains my sole NZX holding.</p>

                <p>Although the stock's performance was somewhat underwhelming, the company's fundamental growth has been strong, and its strategic narrative remains intact. If management continues to strengthen the company's fundamentals, we will maintain our investment. However, we reduced our stake to about {"3600"} NZD, acknowledging that We had an emotional over concentration in the company. As our portfolio grows, we will add more to this company during dips.</p>
              </div>
            </CardContent>
          </Card>
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <div className="bg-blue-50 rounded-lg p-4 min-w-fit">
                  <div className="grid grid-cols-4 gap-4 text-sm">
                    ...
                    <div>
                      <div className="text-gray-600">Final Position</div>
                      <div className="font-semibold">{formatNumber(20, 0)} shares</div>
                    </div>
                    <div>
          ...
          <Card className="border-blue-100">
            ...
            <CardContent>
              <div className="prose text-gray-700">
                ...
                <p>A great buying opportunity opened when 2 short-term bad news events caused a 20% sell-off. Firstly, there was a cyber-attack on a subsidiary of the company resulting in large loss of medical information to hackers and secondly, the final Medicare advantage payments for 2025 came below expectations. This will reduce revenues for UNH in 2025. However, both events have little long-term implications. Thus, we bought a roughly {"2500"} NZD position in the company at an average price per share of $493 USD over the course of Feb-June. The position then recovered over the year as UNH demonstrated that it can effectively navigate these changes and deliver on its goals.</p>

                <p>In early December, we decided to sell our position due to a significant event: the assassination of United Healthcare's CEO, Brian Thompson, in midtown New York on the morning of the annual investor day. This incident brought intense media scrutiny to the American healthcare industry. we discovered the unethical practices within the industry, such as the high rate of claim denials by health insurance companies, with United Healthcare leading at 33%. It's clear the US healthcare system exploits customers, many of whom have no other choice due to employer-provided insurance. Importantly this event greatly increased the risk of healthcare insurance reform due to public pressure could harm the company's long-term prospects.</p>

                <p>We sold at an average price of $582 USD and used the cash for another buying opportunity that was waiting for me. we were fortunate with this trade, but time will tell if it was the right decision.</p>
              </div>
            </CardContent>
          </Card>
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <div className="bg-blue-50 rounded-lg p-4 min-w-fit">
                  <div className="grid grid-cols-4 gap-4 text-sm">
                    ...
                    <div>
                      <div className="text-gray-600">Final Position</div>
                      <div className="font-semibold">{formatNumber(3, 0)} shares</div>
                    </div>
                    <div>
                      <div className="text-gray-600">Price @31/12/2025</div>
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <div className="bg-blue-50 rounded-lg p-4 min-w-fit">
                  <div className="grid grid-cols-4 gap-4 text-sm">
                    ...
                    <div>
                      <div className="text-gray-600">Final Position</div>
                      <div className="font-semibold">{formatNumber(7, 0)} shares</div>
                    </div>
                    <div>
                      <div className="text-gray-600">Price @31/12/2025</div>
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <div className="bg-blue-50 rounded-lg p-4 min-w-fit">
                  <div className="grid grid-cols-4 gap-4 text-sm">
                    ...
                    <div>
                      <div className="text-gray-600">Final Position</div>
                      <div className="font-semibold">{formatNumber(4, 0)} shares</div>
                    </div>
                    <div>
                      <div className="text-gray-600">Price @31/12/2025</div>
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <div className="bg-blue-50 rounded-lg p-4 min-w-fit">
                  <div className="grid grid-cols-4 gap-4 text-sm">
                    ...
                    <div>
                      <div className="text-gray-600">Final Position</div>
                      <div className="font-semibold">{formatNumber(1.23, 0)} shares</div>
                    </div>
                    <div>
                      <div className="text-gray-600">Price @31/12/2025</div>
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <div className="bg-blue-50 rounded-lg p-4 min-w-fit">
                  <div className="grid grid-cols-4 gap-4 text-sm">
                    ...
                    <div>
                      <div className="text-gray-600">Final Position</div>
                      <div className="font-semibold">{formatNumber(6, 0)} shares</div>
                    </div>
                    <div>
                      <div className="text-gray-600">Price @31/12/2025</div>
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <div className="bg-blue-50 rounded-lg p-4 min-w-fit">
                  <div className="grid grid-cols-4 gap-4 text-sm">
                    ...
                    <div>
                      <div className="text-gray-600">Final Position</div>
                      <div className="font-semibold">{formatNumber(2, 0)} shares</div>
                    </div>
                    <div>
                      <div className="text-gray-600">Price @31/12/2025</div>
          ...
          <Card className="border-blue-100">
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <div className="bg-blue-50 rounded-lg p-4 min-w-fit">
                  <div className="grid grid-cols-4 gap-4 text-sm">
                    ...
                    <div>
                      <div className="text-gray-600">Final Position</div>
                      <div className="font-semibold">{formatNumber(35, 0)} shares</div>
                    </div>
                    <div>
                      <div className="text-gray-600">Price @31/12/2025</div>
            ...
            <CardContent>
              <div className="prose text-gray-700">
                ...
                <p>Seeing this as an opportunity, I completed a position of {"35"} shares at an average cost of $68 USD. I plan to increase our stake to 15% of our portfolio while the price remains below $75 USD, as this should provide a sufficient margin of safety.</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-blue-100">
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <div className="bg-blue-50 rounded-lg p-4 min-w-fit">
                  <div className="grid grid-cols-4 gap-4 text-sm">
                    ...
                    <div>
                      <div className="text-gray-600">Final Position</div>
                      <div className="font-semibold">{formatNumber(11, 0)} shares</div>
                    </div>
                    <div>
                      <div className="text-gray-600">Price @31/12/2025</div>
            ...
            <CardContent>
              <div className="prose text-gray-700">
                ...
                <p>I invested in Google this year following judicial rulings affirming its status as an illegal monopoly, which I agree with as it has achieved this through not only superior products but lucrative anti-competitive deals, this monopoly currently poses no harm and continues to innovate. Moreover, concerns over AI's potential disruption of the search business and resultant stock volatility, we believe Google will navigate these challenges successfully through innovation and legal strategies. Consequently, I acquired {"11"} shares at an average price of $174 USD in early December, following the sale of my UNH holdings. I consider Google undervalued at current prices and plan to increase our stake throughout the year.</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-blue-100">
            ...
            <CardContent>
              <div className="prose text-gray-700">
                <p>This ended up being a much longer write than initially anticipated, going forward from next year. I expect this review to be a lot shorter as I don't expect to add too many new positions. we will mostly give an update on the performance of my existing companies, rather than describing the moat and investment case. we will only do that for my new positions.</p>

                <p>As of now, I have a few companies on my watchlist in no order. ASML, FTNT, SNOW, MSFT, TXRH, COST, ANET, TSM, V, FICO, NOW, VICI, FDS. However, we think our portfolio is fairly high quality already and still has many undervalued companies, that I would prefer to add to. So, nothing may arise of this watchlist.</p>

                <p>Overall, all of my companies executed their vision and I am pleased with their performance. I quite liked the way We started many of the positions. we bought an initial position in a company I like at a reasonable valuation, usually before earnings and then if it dipped after earnings I could add more at a discount. This was largely possible due to some very volatile earnings this year. And I hope this behavior continues.</p>
